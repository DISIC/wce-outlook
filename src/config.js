...
const PHONE_NUMBERS_API_URL = "https://webconf.numerique.gouv.fr/voxapi/api/v1/conn/jitsi/phoneNumbers";
const PHONE_PIN_CODE_API_URL = "https://webconf.numerique.gouv.fr/voxapi/api/v1/conn/jitsi/conference/code";
